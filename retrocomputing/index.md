...
[^1]: Хай і без фанатизму в чистоті. 
...
1. Розпочнемо із самої машини: [портативні комп'ютери Osborne](cpm/osbornes.md).
2. Щоб працювати із Osborne, потрібні дискети. Створення їх -- нетривіальна задача. [Як я її, (чесно кажучи -- блукаючи манівцями), вирішував](cpm/disk_images.md).
