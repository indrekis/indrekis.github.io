...
- [Пропрієтарні розширення]({% post_url /retrocomputing/ibm_pc_compat/2024-08-07-juko_xt_mb %}#пропрієтарні-розширення)
	- [Дизасемблювання TURBO.COM та відповідних обробників BIOS]({% post_url /retrocomputing/ibm_pc_compat/2024-08-07-juko_xt_mb %}#дизасемблювання-turbocom-та-відповідних-обробників-bios)
	...
	- [Дизасембльовані файли]({% post_url /retrocomputing/ibm_pc_compat/2024-08-07-juko_xt_mb %}#дизасембльовані-файли)
		- [TURBO.COM]({% post_url /retrocomputing/ibm_pc_compat/2024-08-07-juko_xt_mb %}#turbocom)
		        - [EMS-драйвер]({% post_url /retrocomputing/ibm_pc_compat/2024-08-07-juko_xt_mb %}#ems-драйвер)
...
## Дизасемблювання TURBO\.COM та відповідних обробників BIOS 
...
Дизасемблювавши обробник int 15h з BIOS, бачимо такий код: 
...
- Виведення в порт 0: використовувати положення джампера.
- Виведення в порт 2: Turbo on.
- Виведення в порт 3: Turbo off.

Інших функцій обробник не підтримує. Хіба що, з точки зору емуляції, цікаво, як поведе себе плата, якщо перед тим  не читати з того порта.
...
Покладаючись на такий простенький банкінг, George Lefterov розробив драйвер, який емулює EMS. Для цього він резервує верхніх 64 Кб звичайної (conventional) пам'яті та використовує її як кадр EMS. Тоді під час зміни відображень EMS він тимчасово змінює відображення плати, копіює дані і повертає звичайне відображення.

За подачі [колеги по хобі](https://www.facebook.com/babayev.pavel) я його дизасемблював, довів до стану компілювабельності та виправив трохи багів. Відповідний проєкт з детальнішим описом -- тут: [https://github.com/indrekis/JukoST_EMS](https://github.com/indrekis/JukoST_EMS). 
